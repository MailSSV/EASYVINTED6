...
import { Package, FileText, CheckCircle2, Clock, Send, DollarSign, Eye, ClipboardEdit, Upload, Flower2, Sun, Leaf, Snowflake, CloudSun, ChevronLeft, ChevronRight, Loader, AlertCircle } from 'lucide-react';
