          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Gerez vos articles en 1 seul endroit! (Vous avez {items.filter(item => item.type === 'article').length} {items.filter(item => item.type === 'article').length === 1 ? 'article' : 'articles'} dans votre dressing)
              </p>
            </div>
