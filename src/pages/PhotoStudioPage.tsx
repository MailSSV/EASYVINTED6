...
import { Image as ImageIcon, Wand2, FileText, Download, ZoomIn, ZoomOut, Maximize2, Move, AlertCircle, Plus, Search, User } from 'lucide-react';
...
export function PhotoStudioPage() {
  ...
  const [activeTab, setActiveTab] = useState<'details' | 'studio' | 'defects' | 'tryon'>('details');
            ...
            <div className="w-full lg:w-1/2 flex flex-col h-full bg-white relative z-10">
              ...
              <div className="flex items-center border-b border-gray-200 px-4 pt-4 gap-6 shrink-0 bg-white z-10 sticky top-0">
                ...
                <button
                  ...
                  className={`pb-4 px-2 text-sm font-semibold flex items-center gap-2 transition-all relative ${
                    activeTab === 'defects' ? 'text-amber-600' : 'text-gray-500 hover:text-gray-700'
                  }`}
                >
                  <Search size={18} />
                  Defauts
                ...
                <button
                  ...
                  className={`pb-4 px-2 text-sm font-semibold flex items-center gap-2 transition-all relative ${
                    activeTab === 'tryon' ? 'text-rose-600' : 'text-gray-500 hover:text-gray-700'
                  }`}
                >
                  <User size={18} />
                  Mannequin
                    ...
                    <div className="space-y-4">
                      ...
                      {currentImage && (
                        <DefectDetector
                          ...
                          mimeType={mimeType}
                          onConditionDetected={(condition) => {
                            if (products.length > 0) {
                              const updatedProducts = [...products];
                              updatedProducts[0] = { ...updatedProducts[0], condition };
                    ...
                    <div className="space-y-4">
                      <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl p-4 border border-rose-200">
                        ...
                        <p className="text-sm text-rose-700">
                          Generez une image de votre vetement porte par un mannequin virtuel.
                          Parfait pour montrer le rendu du vetement porte et attirer plus d'acheteurs.
                        </p>
                      </div>
                      {currentImage && (
                        <VirtualTryOn
